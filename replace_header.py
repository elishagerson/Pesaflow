...
with open('lib/presentation/transactions/transaction_list_screen.dart', 'r') as f:
    content = f.read()
...
pattern = re.compile(r'            // ── HEADER ──.*?            // ── TRANSACTION LIST ──', re.DOTALL)
new_content = pattern.sub(replacement + "\n            // ── TRANSACTION LIST ──", content)

with open('lib/presentation/transactions/transaction_list_screen.dart', 'w') as f:
    f.write(new_content)
