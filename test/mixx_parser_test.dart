...
void main() {
  test('Mixx parser payment successful to sporty bet', () {
    ...
    print('Parsed: amount=${parsed?.amount}, type=${parsed?.type}, recipient=${parsed?.senderOrRecipient}, fee=${parsed?.feeAmount}, ref=${parsed?.reference}, bal=${parsed?.balanceAfter}');
  });
}
